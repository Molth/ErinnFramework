...
namespace Erinn
{
    ...
    ///     MessageProcessor
    /// </summary>
    internal sealed class NetworkClientMessageFuncProcessor<TRequest, TResponse> : NetworkClientMessageFuncProcessorBase where TRequest : struct, INetworkMessage, IMemoryPackable<TRequest> where TResponse : struct, INetworkMessage, IMemoryPackable<TResponse>
    {
        /// <summary>
        ///     Server
        /// </summary>
        ...
        public NetworkClientMessageFuncProcessor(NetworkClient networkClient, Func<TRequest, TResponse> handler)
        {
