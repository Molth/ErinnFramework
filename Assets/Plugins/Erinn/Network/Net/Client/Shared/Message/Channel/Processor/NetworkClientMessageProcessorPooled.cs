...
namespace Erinn
{
    ...
    ///     MessageProcessor
    /// </summary>
    internal sealed class NetworkClientMessageProcessorPooled<T> : NetworkClientMessageProcessorBase where T : struct, INetworkMessage, IMemoryPackable<T>
    {
        /// <summary>
        ///     Handler
        /// </summary>
        ...
        public NetworkClientMessageProcessorPooled(Action<T> handler) => _handler = handler;
