...
namespace Erinn
{
    ...
    ///     MessageProcessor
    /// </summary>
    internal sealed class NetworkClientMessageFuncAllocator<TRequest, TResponse> : NetworkClientMessageFuncProcessorBase where TRequest : struct, INetworkMessage, IMemoryPackable<TRequest> where TResponse : struct, INetworkMessage, IMemoryPackable<TResponse>
    {
        /// <summary>
        ///     Server
        /// </summary>
        ...
        public NetworkClientMessageFuncAllocator(NetworkClient networkClient, Func<TRequest, TResponse> handler)
        {
