...
namespace Erinn
{
    ...
    ///     Write
    /// </summary>
    public readonly partial struct NetworkWriter : ISettable, INetworkBuffer, INetworkWriter, IEquatable<NetworkWriter>
    {
        /// <summary>
        ///     Buffer zone
        /// </summary>
        ...
        public NetworkWriter(int capacity) => _buffer = new NetworkBuffer(capacity);

        /// <summary>
        ///     Structure
        /// </summary>
        /// <param name="segment">Buffer zone</param>
        public NetworkWriter(ArraySegment<byte> segment) => _buffer = new NetworkBuffer(segment);

        /// <summary>
        ///     Structure
        /// </summary>
        /// <param name="bytes">Buffer zone</param>
        public NetworkWriter(byte[] bytes) => _buffer = new NetworkBuffer(bytes);
        ...
        public NetworkWriter(byte[] bytes, int count) => _buffer = new NetworkBuffer(bytes, count);
        ...
        /// <param name="count">Length</param>
        public NetworkWriter(byte[] bytes, int offset, int count) => _buffer = new NetworkBuffer(bytes, offset, count);

        /// <summary>
        ///     Structure
        /// </summary>
        /// <param name="memoryBuffer">Buffer zone</param>
        public NetworkWriter(NetworkBuffer memoryBuffer) => _buffer = memoryBuffer;

        /// <summary>
        ///     Obtain NetworkReader
        /// </summary>
        /// <returns>Obtained NetworkReader</returns>
        public NetworkReader ToReader() => new(_buffer);
        ...
        public static implicit operator NetworkReader(NetworkWriter writer) => writer.ToReader();
        ...
        public bool Equals(NetworkWriter other) => _buffer == other._buffer;
        ...
        /// <returns>Has the same value as this instance</returns>
        public override bool Equals(object? obj) => obj is NetworkWriter other && Equals(other);
        ...
        /// <returns>Has the same value as this instance</returns>
        public static bool operator ==(NetworkWriter left, NetworkWriter right) => left._buffer == right._buffer;
        ...
        public void Dispose()
        {
            if (NetworkWriterPool.TryReturn(this))
                return;
            Flush();
        }
    }
