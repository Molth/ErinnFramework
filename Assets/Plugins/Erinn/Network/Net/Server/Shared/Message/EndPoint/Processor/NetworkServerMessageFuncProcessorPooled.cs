...
namespace Erinn
{
    ...
    ///     MessageProcessor
    /// </summary>
    internal sealed class NetworkServerMessageFuncProcessorPooled<TRequest, TResponse> : NetworkServerMessageFuncProcessorBase where TRequest : struct, INetworkMessage, IMemoryPackable<TRequest> where TResponse : struct, INetworkMessage, IMemoryPackable<TResponse>
    {
        /// <summary>
        ///     Server
        /// </summary>
        ...
        public NetworkServerMessageFuncProcessorPooled(NetworkServer networkServer, Func<uint, TRequest, TResponse> handler)
        {
