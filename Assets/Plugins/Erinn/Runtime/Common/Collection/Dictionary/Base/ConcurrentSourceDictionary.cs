...
namespace Erinn
{
    ...
    ///     Mapping
    /// </summary>
    public abstract class ConcurrentSourceDictionary<TKey, TValue> : ISourceDictionary<TKey, TValue> where TKey : unmanaged where TValue : notnull
    {
        /// <summary>
        ///     Dictionary
        /// </summary>
        ...
        ///     Index Pool
        /// </summary>
        protected abstract ConcurrentIndexPool<TKey> IndexPool { get; }
