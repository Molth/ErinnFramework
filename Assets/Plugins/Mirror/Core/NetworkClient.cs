...
namespace Mirror
{
    ...
    public struct ConnectionIdMessage : INetworkMessage
    {
        public uint NetId;

        public ConnectionIdMessage(uint netId) => NetId = netId;
    }
    
    /// <summary>NetworkClient with connection to server.</summary>
    public static partial class NetworkClient
    {
        public static uint LocalClientId { get; private set; }
        ...
        public static void Send<T>(T message, int channelId = Channels.Reliable)
            where T : struct, INetworkMessage
        {
            if (connection != null)
            {
        ...
        {
            RegisterHandler<ConnectionIdMessage>(OnConnectionIdMessage, false);
        ...
        private static void OnConnectionIdMessage(ConnectionIdMessage message) => LocalClientId = message.NetId;
