    ...
    public class Readers
    {
        ...
        MethodReference GenerateReader(TypeReference variableReference, ref bool WeavingFailed)
        {
            ...
            else if (variableDefinition.Is(typeof(Dictionary<,>)))
            {
                ...
                return GenerateReadCollection(variableReference, elementType1, elementType2, nameof(NetworkReaderExtensions.ReadDictionary), ref WeavingFailed);
            }
        ...
        MethodDefinition GenerateReadCollection(TypeReference variable, TypeReference elementType1, TypeReference elementType2, string readerFunction, ref bool WeavingFailed)
        {
            MethodDefinition readerFunc = GenerateReaderFunction(variable);
            // generate readers for the element
            GetReadFunc(elementType1, ref WeavingFailed);
            GetReadFunc(elementType2, ref WeavingFailed);
